  ...
  return (
    <div className="w-full space-y-5">
      <p className="font-mono text-xs leading-relaxed text-muted-foreground">
        Envie uma foto <span className="font-bold text-foreground">sua, nítida e bem iluminada</span>. Nada de
        personagens, desenhos, avatares ou memes — precisamos te reconhecer facilmente no campus e na
        plataforma. Formatos: JPG, PNG ou WebP até 2MB.
      </p>
