      ...
      <div className="flex min-h-screen items-center justify-center bg-background px-4">
        ...
        >
          ...
          <p className="mt-2 text-sm opacity-80">
            Se o e-mail informado for válido, você receberá uma mensagem de confirmação em breve.
            Clique no link da mensagem para verificar sua conta. Lembre-se de checar o spam!
          </p>
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-background px-4 py-8">
      ...
      >
        ...
        <h1 className="mt-4 font-sans text-2xl font-bold uppercase leading-none tracking-tight">
          Crie sua conta
        </h1>
        <p className="mt-2 text-sm opacity-80">
        ...
        <form className="mt-6 space-y-4" onSubmit={onSubmit} noValidate>
          <div>
            ...
            <Input id="handle" autoComplete="username" placeholder="nycolas" {...field('handle')} />
