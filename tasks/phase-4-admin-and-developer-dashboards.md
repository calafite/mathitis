...
## Objective
Build administrative control centers for system configuration (including runtime approval workflow toggles and season matching windows), user moderation, request override queues, and technical developer diagnostics without exposing user PII, backed by immutable audit logs, strict path protection, and backend role verification.

## Tasks
- [ ] **4.1 Dynamic System Configuration Module & Audit Logging**
...
- [ ] **4.2 User & Content Moderation API**
...
- [ ] **4.3 Developer Diagnostics & Telemetry API (Least-Privilege & Exposure Auditing)**
...
- [ ] **4.4 Strict Path Protection & Admin Frontend Portals**
  ...
  - Build User Management Table with search, filter, and moderation modal triggers.
